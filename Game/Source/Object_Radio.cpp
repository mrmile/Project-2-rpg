...
Object_Radio::Object_Radio(int x,int y) : Entity(x,y)
{	
	EntityHP = 1;
	EntityAP = 5;
	EntityMP = 3;
	...
	collider = app->collisions->AddCollider({ position.x, position.y, 25, 56 }, Collider::Type::ITEM_RADIO, (Module*)app->entity_manager);

}

bool Object_Radio::Update(float dt)
{
