...
{	
	...
	collider = app->collisions->AddCollider({ position.x, position.y, 25, 56 }, Collider::Type::ITEM_SHORT_RANGE_GUN, (Module*)app->entity_manager);

}

bool Object_ShortScopeGun::Update(float dt)
{
