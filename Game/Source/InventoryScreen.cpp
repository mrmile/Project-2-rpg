...
InventoryScreen::InventoryScreen(bool start_enabled) : Module(start_enabled)
{
	name.Create("InvenotryScreen");
}
...
bool InventoryScreen::Awake()
{
	LOG("Loading Inventory Screen");
	bool ret = true;
...
//bool InventoryScreen::OnGuiMouseClickEvent(GuiControl* control)
//{
//	switch (control->type)
//	{
