...
ScenePlatform::ScenePlatform(bool start_enabled) : Module(start_enabled)
{
	name.Create("ScenePlatform");
}
...
// Called each loop iteration
bool ScenePlatform::Update(float dt)
{
	sceneTimer++;
