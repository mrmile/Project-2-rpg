...
bool EntityManager::Start()
{
	...
	texture_mini_boss_two = app->tex->Load("Assets/textures/Enemies/Lab_Ants/lab_ant.png");
	texture_mini_boss_three = app->tex->Load("Assets/textures/Enemies/Zombies/zombie_farmer.png");
