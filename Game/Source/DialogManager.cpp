	...
	if (app->player->pauseMenu == false && app->player->showCombatHUD == false)
	{
		...
		if (app->player->activateFinalBoss == true)
		{
			...
			if (app->player->finalBossPhaseCounter > 5584 && app->player->finalBossPhaseCounter <= 6184)
			{
				...
				if (app->player->QTE_Counter > 520)app->render->DrawRectangle2(quad, 0, 255, 0, 255, 0.0f, true);
				else if (app->player->QTE_Counter > 150 && app->player->QTE_Counter <= 520)app->render->DrawRectangle2(quad, 255, 255, 0, 255, 0.0f, true);
				else if (app->player->QTE_Counter <= 150)app->render->DrawRectangle2(quad, 255, 0, 0, 255, 0.0f, true);
			...
			{
				if (app->player->finalBossPlayerStrikes >= 4) app->player->playerHP = 0;
				else if (app->player->finalBossPlayerStrikes < 4) app->player->playerWin = true;
