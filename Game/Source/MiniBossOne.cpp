						...
						if (entityTurn == TurnState::FinishTurn)
						{
							...
							if (position.DistanceTo({ app->player->position.x + app->player->collider->rect.w / 2, app->player->position.y - app->player->collider->rect.h }) < 75)
							{
								...
								if ((position.x == app->player->position.x + app->player->collider->rect.w / 2) && (position.y < app->player->position.y - app->player->collider->rect.h))
								{
									...
									app->particles->AddParticle(app->particles->enemyAttack, position.x, position.y + 30, Collider::Type::BOSS_ATTACK);
								...
								if ((position.x < app->player->position.x + app->player->collider->rect.w / 2) && (position.y == app->player->position.y - app->player->collider->rect.h))
								{
									...
									app->particles->AddParticle(app->particles->enemyAttack, position.x + 30, position.y, Collider::Type::BOSS_ATTACK);
								...
								if ((position.x > app->player->position.x + app->player->collider->rect.w / 2) && (position.y > app->player->position.y - app->player->collider->rect.h))
								{
									...
									app->particles->AddParticle(app->particles->enemyAttack, position.x - 30, position.y - 30, Collider::Type::BOSS_ATTACK);
